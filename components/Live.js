...
export default class Live extends Component {
  ...
  setLocation = () => {
    // call when permission granted
    Location.watchPositionAsync({
      enableHighAccuracy: true,
      timeInterval: 1,
      distanceInterval: 1
    }, ({ coords }) => {
      // callback called whenever position changes
    ...
    if (status === 'denied') {
      return (
        <View style={styles.center}>
          ...
          <Text>You denied your location, fix this by visiting settings and enabling the location services for this App.</Text>
        </View>
      )
    }
